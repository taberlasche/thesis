...
The plot shows a similar behaviour to fig. \ref{fig:1}.
\begin{figure}[H]
	\centering
...
An open questions is if it is possible to make the implementation more efficient, to achieve feasible computation for larger qubit numbers, to then test if the code achieves the proved results.
