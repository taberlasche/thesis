...
In this space, there are states $\rho$ which can nThis is the Bloch representation of quantum states.ot be expressed through a tensor product of states in the subsystems $\rho = \rho_1\bigotime\rho_2\ldots\bigotime\rho_N$.
