...
As proved in \cite{goyal16}, the boundary of the Bloch space of qutrits can never stray into the solid ball of radius $\frac{1}{2}$. \todo{show proof?}
...
As a field study\todo{word this differently?}, I have implemented this algorithm and plotted the result, mirroring the procedure described in chapter 4.
The result can be seen in Figure \figref{fig:4}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{tavgplot(4,2000,2,20,20).png}
