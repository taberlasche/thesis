...
Another relevant recent result is an algorithm by Ghabarian and Parekh \cite{gharibian19}, which finds a constant approximation ratio for the quantum Heisenberg model.\todo{should i go deeper into these two and/or other algos}
